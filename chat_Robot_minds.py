...
def show_information_robot_page():
    st.title("Agent Coder Robot")
   
   
# Open link in the same tab
    st.markdown('<a href="http://ec2-3-92-141-83.compute-1.amazonaws.com:3000/chatbot/4ddce197-2f1a-4a69-bc98-8512e9049641" target="_self">Agent Coder Robot(Same Tab)</a>', unsafe_allow_html=True)
